...
function ThreadViewer() {
    ...
    useEffect(() => {
        async function fetchThread() {
            try {
                ...
                const response = await axios.get(`https://hypet-145797464141.us-central1.run.app/api/thread/${threadId}`, {
    ...
    const handleCreatePost = async () => {
        ...
        try {
            ...
            await axios.post(
                `https://hypet-145797464141.us-central1.run.app/api/thread/${threadId}/posts`,
                {
                    title: title,
                    content: content
                },
