...
export default function FriendCheck() {
  ...
  const checkFriendship = async () => {
    const response = await fetch("http://localhost:8080/api/check_friends", {
      method: "POST",
  ...
  const handleAddFriend = async () => {
    await fetch("http://localhost:8080/api/add_friend", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleRemoveFriend = async () => {
    await fetch("http://localhost:8080/api/remove_friend", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
