...
export default function SettingsMenu() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      await axios.delete("https://hypet-145797464141.us-central1.run.app/api/api/users/me/delete", {
  ...
  const saveChanges = async () => {
    ...
    try {
      if (activeTab === "profile") {
        ...
        await axios.put("https://hypet-145797464141.us-central1.run.app/api/api/users/me", body, {
          headers: { Authorization: `Bearer ${token}` },
        });
        ...
        await axios.put("https://hypet-145797464141.us-central1.run.app/api/api/users/me/password", body, {
          headers: { Authorization: `Bearer ${token}` },
        });
